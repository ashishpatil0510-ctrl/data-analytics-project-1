...
4. 💡 Recommendations
Seasonal campaigns: Pre-load inventory and launch campaigns by September to capture Q4 holiday surge.
International expansion: Run targeted paid campaigns in Germany & France — both show high order frequency.
Bundling strategy: Pair high-volume low-margin products with premium items to raise average order value.
AOV nudge: Introduce free-shipping threshold above £600 to push the current £534 AOV upward.
Stock protection: Maintain buffer inventory for top 10 revenue products — stockouts on these directly hurt revenue.
🛠️ How to Run
Prerequisites
...
Extracted Month, Quarter, Year features
📚 Tools Used
Tool	Purpose
